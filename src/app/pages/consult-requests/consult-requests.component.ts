...
@Component({
  selector: 'app-consult-requests',
  templateUrl: './consult-requests.component.html',
  styleUrls: ['./consult-requests.component.scss']
})
export class ConsultRequestsComponent implements AfterViewInit {
